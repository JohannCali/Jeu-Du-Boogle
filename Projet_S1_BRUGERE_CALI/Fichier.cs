...
namespace Projet_S1_BRUGERE_CALI
{
    public class Fichier 
    {
        ...
        /// <summary>
        /// renvoie les données de fichierlettre sous forme de matrice
        /// </summary>
        /// <param name="f"></param>
        /// <returns></returns>
        public static string[,] RecupererDonneesFichierLettres(Fichier f)  
        {
        ...
        /// <summary>
        /// 5389 itérations sur le fichier test et inutilisable sur le fichier initial
        /// </summary>
        /// <param name="f"></param>
        /// <returns></returns>
        public string[] TriBulle(Fichier f)
        {
        ...
        /// <summary>
        /// 4686 itérations sur le fichier test et inutilisable sur le fichier initial
        /// </summary>
        /// <param name="f"></param>
        /// <returns></returns>
        public string[] TriCocktail(Fichier f)
        {
            string[] line = File.ReadAllLines(f.Chemin);
            string[] trié = line[0].Split(' ', StringSplitOptions.RemoveEmptyEntries);
        ...
        /// <summary>
        /// 448 itérations sur le fichier test et 2053939 sur les fichiers du jeu
        /// Les programmes DiviserPourRégner et Fusionner servent pour le TriFusion
        /// </summary>
        /// <param name="f"></param>
        /// <returns></returns>
        public string[] TriFusion(Fichier f)  
        {
            string[] line = File.ReadAllLines(f.Chemin);
        ...
        /// <summary>
        /// 4104 itérations sur le fichier test et inutilisable sur le fichier initial
        /// </summary>
        /// <param name="f"></param>
        /// <returns></returns>
        public string[] TriSelection(Fichier f)
        {
            string[] line = File.ReadAllLines(f.Chemin);
            string[] trié = line[0].Split(' ', StringSplitOptions.RemoveEmptyEntries);
            int compteur = 0;
        ...
        /// <summary>
        /// 1819 itérations sur le fichier test et inutilisable sur le fichier initial
        /// </summary>
        /// <param name="f"></param>
        /// <returns></returns>
        public string[] TriInsertion(Fichier f)  
        {
            string[] line = File.ReadAllLines(f.Chemin);
            string[] trié = line[0].Split(' ', StringSplitOptions.RemoveEmptyEntries);
