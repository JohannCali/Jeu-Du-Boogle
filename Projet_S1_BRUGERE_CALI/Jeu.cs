...
// j'ai utilisé wordCloudSharp pour creer le nuage de mot 
...
namespace Projet_S1_BRUGERE_CALI
{
    public class Jeu
    {
        ...
        public Jeu()
        {
            ...
            int taille; // pour récupérer le taille de la grille 
            ...
            do
            {
                ...
                else
                {
                    ...
                    for (int i = 0; i < a; i++)
                    {
                        ...
                        // si le nom du joueur n'est pas rentré ou ne contient que des espaces, le nom du joueur est Joueur + le numero du joueur
        ...
        public static void Jouer() 
        {
            ...
            for (int i = 0; i < jeu.nbjoueurs; i++) // lancer le tour de chaque joueur
            {
                ...
                DateTime fin = DateTime.Now.AddSeconds(10); // lance un compte à rebours en secondes 
