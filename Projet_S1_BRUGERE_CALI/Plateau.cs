...
namespace Projet_S1_BRUGERE_CALI
{
    public class Plateau
    {
        ...
        private List<char> liste;         
        private Dé dé;                   
        private List<char> listegrille;   
        ...
        /// <summary>
        /// vérifie si le mot est éligible par rapport à la configuration du plateau
        /// </summary>
        /// <param name="mot"></param>
        /// <param name="matrice"></param>
        /// <returns></returns>
        public bool Test_Plateau(string mot, char[,] matrice) 
        {
            mot = mot.ToUpper();   
