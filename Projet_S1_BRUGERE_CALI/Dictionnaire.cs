...
namespace Projet_S1_BRUGERE_CALI
{
    public class Dictionnaire
    {
        ...
        /// <summary>
        /// Recherche un mot en le comparant avec tous les mots du dictionnaire
        /// </summary>
        /// <param name="dico"></param>
        /// <param name="motcible"></param>
        /// <returns></returns>
        public bool VerifPresenceMotLineaire(Dictionnaire dico, string motcible) // pas assez optimisé car trop simple, ne prend pas assez en compte le trie
        {
        ...
        /// <summary>
        /// Recherche un mot par dichotomie
        /// </summary>
        /// <param name="dico"></param>
